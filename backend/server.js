...
app.post("/users", async (req, res) => {
  try {
    ...
    */
    const passwordHash = await bcrypt.hash(password, saltRounsds);
    ...
    */
    await db.prepare("INSERT INTO users (name, email, password_hash) VALUES (?, ?, ?).run(name, email, passwordHash));
